...
#ifndef RRIL_SILO_SIM_SWI_H
#define RRIL_SILO_SIM_SWI_H
...
class CSilo_SIM_SW : public CSilo_SIM
{
public:
    CSilo_SIM_SW(CChannel *pChannel);
    virtual ~CSilo_SIM_SW();
};

#endif // RRIL_SILO_SIM_SWI_H
