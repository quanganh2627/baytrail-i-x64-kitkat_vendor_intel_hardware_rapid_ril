...
#ifndef RRIL_SILO_NETWORK_SWI_H
#define RRIL_SILO_NETWORK_SWI_H
...
class CSilo_Network_SW : public CSilo_Network
{
public:
    CSilo_Network_SW(CChannel *pChannel);
    virtual ~CSilo_Network_SW();
};

#endif // RRIL_SILO_NETWORK_SWI_H
