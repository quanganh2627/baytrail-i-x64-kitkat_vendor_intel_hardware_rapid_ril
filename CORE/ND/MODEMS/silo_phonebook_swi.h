...
#ifndef RRIL_SILO_PHONEBOOK_SWI_H
#define RRIL_SILO_PHONEBOOK_SWI_H
...
class CSilo_Phonebook_SW : public CSilo_Phonebook
{
public:
    CSilo_Phonebook_SW(CChannel *pChannel);
    virtual ~CSilo_Phonebook_SW();
};

#endif // RRIL_SILO_PHONEBOOK_SWI_H
