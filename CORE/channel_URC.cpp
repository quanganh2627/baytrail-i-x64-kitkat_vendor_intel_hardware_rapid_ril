...
INITSTRING_DATA URCBasicInitString   = { "E0V1Q0X4|+CMEE=1|S0=0|+XSIMSTATE=1|+XSIMSTATE?|+XCALLSTAT=1|+CTZU=1|+XNITZINFO=1|+CREG=2|+CGREG=2|+CGEREP=1,0|+CSSN=1,1|+CMGF=0|+XCSQ=1|+XLEMA=1" };
#else // USE_CGREG_FOR_GPRS_REG_STATUS
INITSTRING_DATA URCBasicInitString   = { "E0V1Q0X4|+CMEE=1|S0=0|+XSIMSTATE=1|+XSIMSTATE?|+XCALLSTAT=1|+CTZU=1|+XNITZINFO=1|+CREG=2|+XREG=2|+CGEREP=1,0|+CSSN=1,1|+CMGF=0|+XCSQ=1|+XLEMA=1" };
