...
//  All URCs go on this channel.
INITSTRING_DATA URCBasicInitString   = { "E0V1Q0X4|S0=0|+CMEE=1|+XSIMSTATE=1|+XCALLSTAT=1|+CTZU=1|+CTZR=1|+XREG=1|+CREG=2|+CGREG=2|+CGEREP=1,0|+CSSN=1,1|+CMGF=0|+XLEMA=1" };
