...
INITSTRING_DATA ATCmdDefBasicInitString    = { "E0V1Q0X4|+CMEE=1|S0=0|+XGENDATA|+XCALLNBMMI=1|+XPOW=0,0,0|+XDATACHANNEL=1,0,\"/mux/12\",\"/mux/5\",2" };
INITSTRING_DATA ATCmd2230BasicInitString   = { "E0V1Q0X4|+CMEE=1|S0=0|+XGENDATA|+XCALLNBMMI=1|+XPOW=0,0,0|+XSIMSTATE=1|+XSIMSTATE?|+XCALLSTAT=1|+CTZU=1|+XNITZINFO=1|+CREG=2|+CGREG=2|+CGEREP=1,0|+CSSN=1,1|+CMGF=0|+XCSQ=1|+XLEMA=1|+CMGF=0|+XDATACHANNEL=1,0,\"/mux/12\",\"/mux/5\",2" };
...
#if defined(M2_VT_FEATURE_ENABLED)
INITSTRING_DATA ATCmdDefBasicInitString    = { "E0V1Q0X4|+CMEE=1|S0=0|+XCALLNBMMI=1|+XPOW=0,0,0|+XDATACHANNEL=1,0,\"/mux/12\",\"/mux/5\",2" };
INITSTRING_DATA ATCmd2230BasicInitString   = { "E0V1Q0X4|+CMEE=1|S0=0|+XCALLNBMMI=1|+XPOW=0,0,0|+XSIMSTATE=1|+XSIMSTATE?|+XCALLSTAT=1|+CTZU=1|+XNITZINFO=1|+CREG=2|+CGREG=2|+CGEREP=1,0|+CSSN=1,1|+CMGF=0|+XCSQ=1|+XLEMA=1|+CMGF=0|+XDATACHANNEL=1,0,\"/mux/12\",\"/mux/5\",2" };
#else // M2_VT_FEATURE_ENABLED
