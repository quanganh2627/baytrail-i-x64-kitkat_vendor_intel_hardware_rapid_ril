...
// Select any (bitmask)
const int THREAD_FLAGS_NONE = 0x0000;
const int THREAD_FLAGS_START_SUSPENDED = 0x0001;
const int THREAD_FLAGS_JOINABLE = 0x0002;

const int THREAD_WAIT_0 = 0x00000000;
const int THREAD_WAIT_TIMEOUT = 0xFFFFFFFF;
const int THREAD_WAIT_NOT_JOINABLE = 0xFFFF0001;
const int THREAD_WAIT_NOT_INITIALIZED = 0xFFFF0002;
const int THREAD_WAIT_GEN_FAILURE = 0xFFFF0003;
